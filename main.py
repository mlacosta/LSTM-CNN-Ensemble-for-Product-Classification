...
class_dic = U.label_to_integer(list(set(data['category'].to_list()))) #create a class dictionary
...
df = pd.read_excel('CLASSES.xlsX') # can also index sheet by name or fetch all sheet
...
y_p = (y_p_3+y_pred_7+y_pred_8)*.55 + (y_pred_2+y_pred_3+y_pred_4+y_pred_5+y_pred_6)*.45 
